...
\autor{Felipe Ramos Victor \\ Kaue Oliveira dos Anjos}
\local{São Paulo}
\data{2026}
...
O objetivo deste trabalho é Evidenciar as barreiras e limites de algoritmos de criptografia baseados em osciladores caóticos aplicados a sistemas de mensageria. 
A justificativa para este estudo baseia-se em Diversos algoritmos de criptografia são utilizados para a garantia da segurança das informações, 
decidimos então comparar e estudar a viabilidade do uso de algoritmos de criptografia baseados em osciladores caóticos
 com a intenção de mostrar até aonde o mesmo seria utilizável e razoável para sistemas de mensageria. 
 A revisão bibliográfica abrange criptografia baseada em caos, criptografia clássica e técnicas de criptografia multimídia. 
 Como solução proposta, pretende-se evidenciar as barreiras e limites de algoritmos de criptografia baseados em osciladores caóticos aplicados sistemas de mensageria. 
 Este trabalho está organizado em três capítulos que apresentam a introdução ao tema,
  a revisão bibliográfica que fundamenta a pesquisa, o desenvolvimento com a solução proposta e o cronograma de trabalho, seguidos das referências bibliográficas.

\vspace{\onelineskip}

\noindent
\textbf{Palavras-chave}: Criptografia. Caos. Segurança. Multimídia.
\end{resumo}
...
A introdução deve apresentar o tema do trabalho de forma clara e objetiva, 
situando o leitor no contexto da pesquisa. Neste capítulo, 
são apresentados o contexto no qual o problema se insere, 
a justificativa para a realização do estudo e os objetivos que norteiam o desenvolvimento do trabalho.
...
A criptografia em cenários de comunicação entre pares (P2P) é essencial atualmente para assegurar a segurança e a privacidade. 
Como diversos algoritmos tradicionais já são utilizados para esse fim, decidimos estudar e comparar a viabilidade de métodos baseados 
em osciladores caóticos. A intenção é demonstrar até que ponto essa abordagem seria utilizável e razoável para sistemas de mensageria.
...
Evidenciar as barreiras e limites de algoritmos de criptografia baseados em osciladores caóticos aplicados a sistemas de mensageria.
...
\begin{enumerate}
    \item Implementar algoritmos de criptografia baseados em osciladores caóticos.
    \item Implementar algoritmos de criptografia clássicos.
    \item Comparar computacionalmente os algoritmos implementados.
    \item Implementar um sistema de mensageria.
\end{enumerate}
...
\begin{itemize}
    ...
    \item Taxa de perda pós compressão,
    \item Bytes criptografados por segundo.
\end{itemize}
